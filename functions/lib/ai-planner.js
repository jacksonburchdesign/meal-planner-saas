...
const getAI = () => new genai_1.GoogleGenAI({ apiKey: process.env.GEMINI_API_KEY });
async function generateWeeklyPlanWithAI(recipes, history, currentPlanRecipes, healthyTarget, indulgentTarget) {
    const prompt = `
